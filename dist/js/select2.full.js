  ...
  var S2 = (function () {
    ...
    S2.define("select2/utils", [], function () {
      ...
      Utils.GetUniqueElementId = function (element) {
        ...
        if (
          !(element instanceof Element || element[0] instanceof HTMLElement)
        ) {
          console.error(
            "Utils.GetUniqueElementId: element is not a DOM element",
            element
          );
          return null;
        }
        var select2Id = element[0]
          ? element[0].getAttribute("data-select2-id")
    ...
    S2.define("select2/results", ["./utils"], function (Utils) {
      ...
      Results.prototype.bind = function (container, $container) {
        ...
        container.on("results:select", function () {
          ...
          if (
            ($highlighted &&
              $highlighted.classList &&
              $highlighted.classList.contains(
                "select2-results__option--selected"
              )) ||
            ($highlighted[0] &&
              $highlighted[0].classList &&
        ...
        container.on("results:previous", function () {
          ...
          var currentIndex = Array.prototype.indexOf.call($options, element);
          if (currentIndex <= 0) {
            return;
          }
      ...
      function (BaseSelection, Utils) {
        ...
        MultipleSelection.prototype.update = function (data) {
          ...
          for (var d = 0; d < data.length; d++) {
            ...
            var $choiceDisplay = $selection.querySelector(
    ...
    S2.define("select2/selection/placeholder", [], function () {
      ...
      Placeholder.prototype.update = function (decorated, data) {
        ...
        var renderedElement = this.selection.querySelector(
          ".select2-selection__rendered"
        );
        if (renderedElement) {
          ...
          this.selection.addEventListener("keydown", function (evt) {
            ...
            if (searchElement) {
              ...
              if (KEYS[key] === KEYS.BACKSPACE && searchElement.value === "") {
                ...
                var previousChoice =
                  previousChoices[previousChoices.length - 1];
          ...
          if (this.element.multiple) {
            this.current(function (currentData) {
              ...
              for (var d = 0; d < data.length; d++) {
                ...
                var option = Array.from(self.element.options).find(
            ...
            // Find the corresponding <option> element and mark it as selected
            var option = Array.from(this.element.options).find(
    ...
    S2.define("select2/dropdown", ["./utils"], function (Utils) {
    ...
    S2.define(
      ...
      function (Options, Utils, KEYS) {
        ...
        Select2.prototype.val = function (args) {
          ...
          if (args == null || args.length === 0) {
            return Array.from(this.element.selectedOptions).map(
              (option) => option.value
            );
          }
